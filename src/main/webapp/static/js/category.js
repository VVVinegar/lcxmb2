const category = [{
    ...
    children: [{
        value: '手机',
        keywords: ['手机壳', '充电器', '电池', '耳机', '数据线']
    }, {
        value: '电脑笔记本',
        keywords: ['笔记本', 'mac', '显示器', '键盘', '鼠标', '显卡', '内存', '硬盘', 'SSD']
    }, {
        value: '相机',
        keywords: ['单反', '镜头', '摄像', '胶片']
    }, {
        value: '电玩随身听',
        keywords: ['MP3', 'MP4', 'Wii', 'PSP', 'xbox', 'PS3']
    }, {
        value: '其他',
        isOther: true
    }]
    ...
    children: [{
        value: '教育考试',
        keywords: ['考研英语', '考研数学', '考研政治', '公务员', '艺术考试', '法律考试']
    }, {
        value: '小说散文',
        keywords: ['文集', '人物传记', '网络小说', '杂志期刊', '历史', '军事']
    }, {
        value: '科学技术',
        keywords: ['编程', '电子', '机械', '车辆', '材料']
    }, {
        value: '经济管理',
        keywords: ['创业', '电子商务', '财务管理', '公共管理']
    }, {
        value: '其他',
        isOther: true
    }]
